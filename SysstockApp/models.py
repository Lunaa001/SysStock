...
class Product(models.Model):
    ...
    sucursal = models.ForeignKey(
        Branch, on_delete=models.PROTECT, related_name='productos'
    )
...
class Sale(models.Model):
    ...
    def total(self):
        agg = self.items.aggregate(
            s=models.Sum(
                models.F('cantidad') * models.F('precio_unit'),
